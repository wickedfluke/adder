...
from datetime import datetime, timedelta
from telethon import TelegramClient, events, Button
from telethon.errors import PhoneNumberFloodError, SessionPasswordNeededError, FloodWaitError, PhoneNumberBannedError
from telethon.sessions import StringSession
from telethon.sync import TelegramClient as TMPTelegramClient
from telethon.tl.functions.account import UpdateUsernameRequest, UpdateProfileRequest
...
if not os.path.exists("databaseblack.db"):
    with open("databaseblack.db", "w") as filedb4:
        filedb4.write("tgceo")
    print("database creato! (primo avvio)")
# DEVICES PER CHANGE
    ...
    if True:
        if e.chat_id == ADMIN or e.chat_id in ADMINS:
            if e.text == "/start":
                ...
                if smspva_api == "":
                    if raspacontrol():
                        await e.respond("**Benvenuto "+sdr.first_name+" \n**🧙 **Developer®** 🎩 @daznService 🎩 👋**Salve, sono il tuo raspabot personale, usa i bottoni per muoverti nelle immense funzionalià del** 🤖\n[☞ Guida](https://telegra.ph/AdderNet-GUIDA-08-20)", link_preview=False,
                                        buttons=[[Button.inline("☎️ Account ☎️", "voip")], [Button.inline("💡Voip Utility💡", "utility")], [Button.inline("📳Pannello smspa.com 📳", "smspva_panel")], [Button.inline("📲 Pannello 5sim.net 📲", "5sim_panel")], [Button.inline("📱 Cambia dispositivo", "changedevice")],
                                                 [Button.inline("🥷 Ruba 🥷", "grab"), Button.inline(
                                                     "➕ Raspa ➕", "add")], [Button.inline("🗂 Carica File 🗂", "loadfile")],
                                                 [Button.inline("🛠️ mpostazioni 🛠️", "adminpanel"), Button.inline("🚪 JOIN 🚪", "join")]])
                    else:
                        await e.respond("**Benvenuto "+sdr.first_name+" \n**🧙 **Developer®** 🎩 @daznService 🎩 👋**Salve, sono il tuo raspabot personale, usa i bottoni per muoverti nelle immense funzionalià del** 🤖\n[☞ Guida](https://telegra.ph/AdderNet-GUIDA-08-20)", link_preview=False,
                                        buttons=[[Button.inline("☎️ Account ☎️", "voip")], [Button.inline("💡Voip Utility💡", "utility")], [Button.inline("📳 Pannello smspa.com 📳", "smspva_panel")], [Button.inline("📲 Pannello 5sim.net 📲", "5sim_panel")], [Button.inline("📱 Cambia dispositivo", "changedevice")],
                                                 [Button.inline("🥷 Ruba 🥷", "grab"), Button.inline(
                                                     "➕ Raspa ➕", "add")], [Button.inline("🗂 Carica File 🗂", "loadfile")],
                                                 [Button.inline("🛠️ Impostazioni 🛠️", "adminpanel"), Button.inline("🚪 JOIN 🚪", "join")]])
                else:
                    await e.respond("**Benvenuto "+sdr.first_name+" \n**🧙 **Developer®** 🎩 @daznService 🎩 👋**Salve, sono il tuo raspabot personale, usa i bottoni per muoverti nelle immense funzionalià del** 🤖\n[☞ Guida](https://telegra.ph/AdderNet-GUIDA-08-20)", link_preview=False,
                                    buttons=[[Button.inline("☎️ Account ☎️", "voip")], [Button.inline("💡Voip Utility💡", "utility")], [Button.inline("📳 Pannello smspa.com 📳", "smspva_panel")], [Button.inline("📲 Pannello 5sim.net 📲", "5sim_panel")], [Button.inline("📱 Cambia dispositivo", "changedevice")],
                                             [Button.inline("🥷 Ruba 🥷", "grab"), Button.inline(
...
async def callbackQuery(e):
    ...
    if e.sender_id == ADMIN or e.sender_id in ADMINS:
        ...
        if e.data == b"back":
            ...
            sdr = await e.get_sender()
            if smspva_api == "":
                await e.edit("**Benvenuto "+sdr.first_name+" \n**🧙 **Developer®** 🎩 @Femyx_Top 🎩 👋**Salve, sono il tuo raspabot personale, usa i bottoni per muoverti nelle immense funzionalià del** 🤖\n[☞ Guida](https://telegra.ph/AdderNet-GUIDA-08-20)", link_preview=False,buttons=[[Button.inline("☎️ Account ☎️", "voip")], [Button.inline("💡Voip Utility💡", "utility")], [Button.inline("📳 Pannello smspa.com 📳", "smspva_panel")], [Button.inline("📲 Pannello 5sim.net 📲", "5sim_panel")], [Button.inline("📱 Cambia dispositivo", "changedevice")],
                                      [Button.inline("🥷 Ruba 🥷", "grab"), Button.inline(
                                          "➕ Raspa ➕", "add")], [Button.inline("🗂 Carica File 🗂", "loadfile")],
                                      [Button.inline("🛠️ Impostazioni 🛠️", "adminpanel"), Button.inline(" 🚪JOIN 🚪", "join")]])
            else:
            ...
            device_model=actualdevice["m_name"],
                ...
                device_model=actualdevice["m_name"],
                    ...
                    device_model=actualdevice["m_name"],
                        ...
                        TempClient = TMPTelegramClient(StringSession(ArchSSs[st[1]]), API_KEY, API_HASH,
                                                       device_model=actualdevice["m_name"],
                                                       system_version=actualdevice["s_name"],
                                                       app_version=actualdevice["s_app"])
                    await TempClient.connect()
            ...
            actualdevice = random.choice(devices)
            with open("device.pk", "wb") as pkw2:
                pickle.dump(actualdevice, pkw2)
            await e.answer(
